...
export const mockEvents: Event[] = [
  {
    ...
    description: 'Join us for an amazing outdoor music festival featuring local bands and artists. Food trucks, drinks, and great vibes guaranteed!',
  ...
  },
  {
    ...
    description: 'Explore beautiful mountain trails with fellow hiking enthusiasts. All skill levels welcome. Bring your own gear and snacks.',
    date: new Date('2025-02-20T07:00:00'),
    location: 'Denver, CO',
    category: 'HIKE',
    imageUrl: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&h=400&fit=crop',
    fee: 0,
    isPaidEvent: false,
    eventType: 'HIKE',
    status: 'OPEN',
  ...
  },
  {
    ...
    description: 'Weekly board game night at the community center. We have a huge collection of games from classics to modern favorites.',
    date: new Date('2025-02-10T19:00:00'),
    location: 'Chicago, IL',
    category: 'GAME_NIGHT',
    imageUrl: 'https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=800&h=400&fit=crop',
    fee: 5,
    isPaidEvent: true,
  ...
  },
  {
    ...
    description: 'Network with fellow entrepreneurs and tech enthusiasts. Pitch your ideas, find co-founders, and learn from industry experts.',
  ...
  },
  {
    ...
    description: 'Prepare for the upcoming desert marathon with group training sessions. Professional coaching and hydration stations provided.',
  ...
  },
  {
    ...
    description: 'Guided tour of the latest modern art exhibition. Includes exclusive access to artist meet-and-greet session.',
    date: new Date('2025-02-18T14:00:00'),
    location: 'Chicago, IL',
    category: 'ART',
    imageUrl: 'https://images.unsplash.com/photo-1531243269054-5ebf6f34081e?w=800&h=400&fit=crop',
    fee: 20,
    isPaidEvent: true,
    eventType: 'ART',
    status: 'OPEN',
  ...
  },
  {
    ...
    description: 'Friendly beach volleyball tournament for all skill levels. Teams will be formed on the spot. Prizes for winners!',
  ...
  },
  {
    ...
    description: 'Two-day camping adventure in the Rocky Mountains. Includes campfire cooking, stargazing, and morning yoga.',
    date: new Date('2025-03-08T08:00:00'),
    location: 'Denver, CO',
    category: 'HIKE',
    imageUrl: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&h=400&fit=crop',
    fee: 50,
    isPaidEvent: true,
    eventType: 'HIKE',
    status: 'OPEN',
  ...
  },
  {
    ...
    description: 'Weekly cycling meetup for enthusiasts. 30-mile route through scenic countryside. All bikes welcome.',
  ...
  },
  {
    ...
    description: 'Relaxing yoga session followed by a community picnic. Bring your own mat and a dish to share.',
...
export const mockReviews: Review[] = [
  {
    id: 'review-1',
    rating: 5,
    comment: 'Amazing event! Sarah is an incredible host. Everything was well organized.',
    reviewerId: 'user-1',
  ...
  },
  {
    id: 'review-2',
    rating: 4,
    comment: 'Great hiking experience. Would recommend to anyone who loves nature.',
    reviewerId: 'user-1',
    reviewer: findUser('user-1'),
    recipientId: 'user-4',
