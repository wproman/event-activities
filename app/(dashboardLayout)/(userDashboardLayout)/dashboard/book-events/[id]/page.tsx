...
useEffect(() => {
  ...
  const handleJoinEvent = async () => {
    ...
    try {
      ...
      // For paid events, you might need to send payment method details
      const paymentData = event.isPaidEvent ? {
      ...
      if (result.success) {
        // Check if payment is needed (Stripe redirect)
        if (result.data?.requiresPayment && result.data?.paymentIntent) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            You have successfully {event?.isPaidEvent ? 'paid for and joined' : 'joined'} "{event?.title}"
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            {event.isPaidEvent ? 'Complete your booking for' : 'Join'} "{event.title}"
          </p>
        </div>
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-center">
              <svg className="w-5 h-5 text-red-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {event._count?.participants || 0} / {event.maxParticipants || 'Unlimited'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-500 mt-1">Visa, Mastercard, etc.</div>
                      </Button>
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-500 mt-1">Apple Pay, Google Pay</div>
                      </Button>
                    </div>
                  </div>
  ...
  const currentParticipants = event._count?.participants ?? 0;
